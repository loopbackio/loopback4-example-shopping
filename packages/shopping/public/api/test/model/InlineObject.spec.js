...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Loopback4ExampleShopping.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new Loopback4ExampleShopping.InlineObject();
      //expect(instance).to.be.a(Loopback4ExampleShopping.InlineObject);
    });
