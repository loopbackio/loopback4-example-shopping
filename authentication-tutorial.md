...
![JSON Web Token Authentication Overview](https://loopback.io/pages/en/lb4/imgs/json_web_token_overview.png)
...
1. Scroll to the top of the API Explorer, and you should see an `Authorize`
   ...
   ![](https://loopback.io/pages/en/lb4/imgs/api_explorer_authorize_button.png)

1. Click on the `Authorize` button, and a dialog opens up.

   ![](https://loopback.io/pages/en/lb4/imgs/api_explorer_auth_token_dialog1.png)
...
1. In the `bearerAuth` value field, enter the token string you obtained earlier,
   ...
   ![](https://loopback.io/pages/en/lb4/imgs/api_explorer_auth_token_dialog2.png)
...
1. Scroll down to the `UserController` section to find `GET /users/me`
   ...
   ![](https://loopback.io/pages/en/lb4/imgs/api_explorer_usercontroller_section1.png)
...
{% include note.html content="Since this controller method is obtaining SecurityBindings.USER via [method injection](https://loopback.io/doc/en/lb4/Dependency-injection.html#method-injection) (instead of [constructor injection](https://loopback.io/doc/en/lb4/Dependency-injection.html#constructor-injection) and this method is decorated with the <b>@authenticate</b> decorator, there is no need to specify <b>@inject(SecurityBindings.USER, {optional:true})</b>. See [Using the Authentication Decorator](https://loopback.io/doc/en/lb4/Loopback-component-authentication.html#using-the-authentication-decorator) for details.
" %}
...
![](https://loopback.io/pages/en/lb4/imgs/api_explorer_all_sections_lock_icons1.png)
